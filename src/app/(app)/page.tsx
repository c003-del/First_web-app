...
export default async function HomePage() {
  const [site, posts, texts, viewer] = await Promise.all([
    getSiteSettings(),
    getRecentPosts(8),
  ...
  return (
    <div>
      <section className="glass mb-10 px-6 py-12 sm:px-10 sm:py-16">
        ...
        <EditableText
          tKey="home.hero.headline"
          value={headline}
          editable={viewer.isEditor}
          as="h1"
          className="mt-3 max-w-2xl text-4xl leading-[1.15] sm:text-5xl"
        />
        <EditableText
          ...
          as="p"
          multiline
          className="mt-4 max-w-xl text-[16px] leading-7 text-ink-secondary"
        />
      </section>
